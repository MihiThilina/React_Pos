                ...
                <div className={classes.text_form}>
                    <div className={classes.text_field}>
                        <Grid container spacing={3}>
                            ...
                            <Grid item lg={6} md={6} sm={6} xm={6}>
                                <TextField id="outlined-basic" placeHolder="Name" label="Item name"
                                  variant="filled" size="medium"
                                           onChange={(e) =>{
                                               console.log(e.target.value)
                                               let formData = this.state.formData
                                           ...
                                           style={{width: '60%',marginLeft: '-280px',marginTop:'2px'}}/>
                            </Grid>
                            <Grid item lg={6} md={6} sm={6} xm={6}>
                                <TextField id="outlined-basic" placeHolder="Price" label="Price" 
                                 variant="filled" size="medium"
                                           onChange={(e) =>{
                                               console.log(e.target.value)
                                               let formData = this.state.formData
                           ...
                           {}
                            ...
                            <Grid item lg={12} md={12} sm={12} xm={12} style={{}}
                                ...
                                <GDSEButton size="small" variant="contained" label="save"
                                            ...
                                            style={{width: '20%',marginLeft: '650px',marginTop:'-110px'}}
                                />
                            </Grid>
                        </Grid>
                    </div>
